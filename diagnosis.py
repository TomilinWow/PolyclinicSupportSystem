...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Новый диагноз"))
        self.label.setText(_translate("Dialog", "Диагноз:"))
        self.btn_2.setText(_translate("Dialog", "Создать"))

class Diagnosis(QDialog, Ui_Dialog):
    def __init__(self, connection):
        super().__init__()
        self.setupUi(self)
        self.connection = connection
        self.btn_2.clicked.connect(self.new_diagnosis)
